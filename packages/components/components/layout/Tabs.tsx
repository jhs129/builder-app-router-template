...
export const Tabs = ({ tabs = [], theme = "light", builderBlock, builderContext, headline, isHero = false, className }: TabsProps) => {
              ...
              tab.type === "content" && (
                ...
                >
                  <Blocks
                    ...
                    path={`component.options.tabs.${index}.content.blocks`}
