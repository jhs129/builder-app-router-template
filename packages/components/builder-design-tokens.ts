...
// Design token configuration for the Builder.io editor.
// Exported as data so callers can use it without triggering side effects.
...
// Register the design tokens with the Builder.io editor.
// MUST only be called in a browser/client context (register touches
// browser globals), never during server rendering.
export function registerBuilderDesignTokens(): void {
